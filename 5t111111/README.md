...
クロスコンパイルやスタティックリンクなどでまだまだ課題は残っていますが、現在は Docker などを利用してターゲットの OS/アーキテクチャと合わせたビルド専用の環境を用意することも難しくないため、バイナリで手軽に配布できることで得られる利点は非常に大きいと考えています。まずはこのデプロイの用意さを活用しやすい CLI ツールの開発などを通して、その魅力を感じていただければ幸いです。
