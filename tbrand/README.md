...
つまり**:{{str.id}}**は、strの中身を取り出して先頭に**:**(コロン)をつける、ということを行っております。
...
また以下の説明では、簡単のためにライブラリで使用されている実際のコードとは違うコードになっているところもございます。m(__)m
...
ぜひとも未熟なTopazのソースコードを読んでいただいて、PRいただけたら幸いでございます。m(__)m
